#!/bin/bash
#SBATCH --job-name=run_train    # 作业名，方便识别
#SBATCH --output=/fs0/home/zikaix/Data/zikaix/RetrievalSympfn/logs/slurm-sympfn-train-%j.out         # 标准输出日志
#SBATCH --error=/fs0/home/zikaix/Data/zikaix/RetrievalSympfn/logs/slurm-sympfn-train-%j.err          # 错误输出日志
...
# 4. 运行完成后提示（可选）
echo "✅ 运行完成，日志已保存到 train_${SLURM_JOB_ID}.log"