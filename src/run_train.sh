...
#SBATCH --output=/fs0/home/zikaix/Data/zikaix/logs/slurm-sympfn-train-%j.out         # 标准输出日志
#SBATCH --error=/fs0/home/zikaix/Data/zikaix/logs/slurm-sympfn-train-%j.err          # 错误输出日志
